...
export const ToolsDirectoryPage: React.FC<ToolsDirectoryPageProps> = ({ onNavigateHome, onLaunchTool }) => {
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-4">
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          ...
          <div className="flex items-center gap-1.5 bg-emerald-950/60 border border-emerald-500/30 text-emerald-300 text-xs px-3 py-1 rounded-full font-bold">
            <Sparkles className="w-3.5 h-3.5 text-emerald-400" /> Career & Productivity Suite
          </div>
        </div>
      </div>
