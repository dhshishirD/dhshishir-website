...
import { Sparkles, Lock, CheckCircle2, Flame, BookOpen, Mic, Calendar } from 'lucide-react';

export const FluencyLabHub: React.FC = () => {
  const [profile, setProfile] = useState<FluencyUserProfile>(getFluencyProfile());
  const [activeTab, setActiveTab] = useState<'stage1' | 'stage2' | 'stage3' | 'stage4' | 'stage5' | 'stage6'>('stage4');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
          ...
          >
            ...
            <div className="text-xs font-bold mt-0.5 flex items-center gap-1 text-white">
              <Calendar className="w-3.5 h-3.5 text-amber-400" /> Daily Prompts
            </div>
          </button>
