...
export const DiagnosticQuiz: React.FC<DiagnosticQuizProps> = ({
  ...
  return (
    <div className="bg-white/85 border border-slate-200 rounded-3xl p-6 md:p-8 backdrop-blur-xl shadow-2xl text-slate-900 space-y-6">
      ...
      <div className="space-y-5">
        ...
        {currentQuestion.type === 'listening' && currentQuestion.audioSpeechText && (
          <div className="p-4 bg-white rounded-2xl border border-teal-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            return (
              ...
              >
                ...
                <span className={`w-5 h-5 rounded-full border flex items-center justify-center text-[10px] shrink-0 ml-3 ${
                  isSelected ? 'border-emerald-400 bg-teal-50 text-teal-800 font-bold' : 'border-slate-200 text-slate-600'
                }`}>
                  {isSelected ? '✓' : ''}
                </span>
              </button>
