    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      <div className="bg-white border border-slate-200 border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handlePrint}
            className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl text-xs font-bold flex items-center gap-2 shadow-lg shadow-xs transition cursor-pointer"
          >
      ...
      <div className="p-8 sm:p-12 bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950/40 rounded-3xl border-2 border-amber-500/40 shadow-2xl space-y-8 text-center relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between max-w-2xl mx-auto gap-6 pt-4 text-xs text-slate-500">
          ...
          <div className="w-20 h-20 rounded-full border-2 border-dashed border-amber-500/40 p-1 flex items-center justify-center">
            <div className="w-full h-full rounded-full bg-teal-50 flex flex-col items-center justify-center text-amber-400 text-[9px] font-bold uppercase">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 space-y-6 shadow-2xl">
              ...
              >
                ...
                <div className="shrink-0">
                  {isFlagged ? (
                    ...
                    <span className="text-[10px] px-2 py-0.5 rounded bg-teal-50 text-teal-900 font-bold border border-teal-200 flex items-center gap-1">
