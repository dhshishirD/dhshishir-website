            ...
            return (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-2 leading-relaxed line-clamp-3">{preset.description}</p>
                </div>
              </button>
            );
          })}
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-xl space-y-6">
            <div className="flex items-center justify-between border-b border-slate-200 pb-3">
              ...
              <span className="text-xs text-slate-600">5 Calibration Vectors</span>
            </div>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`p-3 rounded-xl border text-left transition cursor-pointer ${
                      alignment === item.id
                        ? 'bg-teal-50 border-teal-200/60 text-slate-900 shadow'
                        : 'bg-white border-slate-200 text-slate-600 hover:text-slate-800 hover:border-slate-200'
                    }`}
                  >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="h-2 w-full bg-white rounded-full overflow-hidden border border-slate-200">
                  <div 
                    className="h-full bg-white border border-slate-200 transition-all duration-500 rounded-full"
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 shadow-2xl space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-900 font-bold text-sm shadow">
              DH
            </div>
            <div>
          ...
          <div className="text-xs font-mono px-3 py-1 rounded-lg bg-white text-slate-600 border border-slate-200">
