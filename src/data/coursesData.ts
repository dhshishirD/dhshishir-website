...
export const COURSES_DATA: Course[] = [
  ...
  {
    id: '10ms-ielts-live-batch',
    title: 'IELTS LIVE Batch (আইইএলটিএস লাইভ ব্যাচ)',
    provider: '10 Minute School',
    category: 'English',
    instructor: 'Senior Cambridge Certified Trainers',
    originalPrice: 8500,
    discountPrice: 6500,
    rating: 4.95,
    studentsCount: '35,000+',
    features: ['Live Interactive Masterclasses', '1-on-1 Speaking Mock Tests', 'Writing Task 1 & 2 Paper Evaluation', 'Full Cambridge Mock Exam Simulation'],
    affiliateUrl: 'https://10ms.io/hKLSB8',
    promoCode: 'SHISHIR10',
  ...
  {
    id: '10ms-ielts-mock-tests',
    title: 'IELTS Reading & Listening Mock Tests (মক টেস্ট সিরিজ)',
    provider: '10 Minute School',
    category: 'English',
    instructor: '10MS Assessment Team',
    originalPrice: 1500,
    discountPrice: 950,
    rating: 4.9,
    studentsCount: '40,000+',
    features: ['Authentic Full-Length Reading & Listening Mocks', 'Instant Band Score Predictor', 'Detailed Answer Explanations', 'Exam Pacing Timers'],
    affiliateUrl: 'https://10ms.io/eKLSMe',
    promoCode: 'SHISHIR10',
    badge: 'Official Mock Series',
    image: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=600&auto=format&fit=crop&q=80'
  },
  {
    id: '10ms-ielts-course',
    title: 'IELTS Recorded Master Course by Munzereen Shahid',
    provider: '10 Minute School',
    category: 'English',
    instructor: 'Munzereen Shahid (Oxford Alumna)',
    originalPrice: 3500,
    ...
    affiliateUrl: 'https://10ms.io/FKLSLS',
    promoCode: 'SHISHIR10',
